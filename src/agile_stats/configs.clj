...
(def ds { ;:renew-db true
         :sprint-end-date (t/offset-date-time 2021 7 2)
...
(def status-categories {:todo #{"To Do" "Dependent" "Can be groomed" "To be defined" "Selected for dev"}
                        :wip #{"Blocked" "To Be Fixed" "Design Review" "In Progress" "R4 Code Review" "Code Review" "R4 Testing" "Testing" }
                        :done #{"R4 Merge" "Approval" "Merge" "R4 Release" "Release" "Done"}})

(def status-categories-done {:todo #{"To Do" "Dependent" "Can be groomed" "To be defined" "Selected for dev"}
                        :wip #{"Blocked" "To Be Fixed" "In Progress" "Design Review" "R4 Code Review" "Code Review" "R4 Testing" "Testing" "R4 Merge" "Approval" "Merge" "R4 Release" "Release"}
                        :done #{"Done"}})
